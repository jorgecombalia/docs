...
exclude_patterns = ['_build', '_guide', '_articles']
...
html_theme_options = {
	'scripts' : ['_static/jquery.js', '_static/underscore.js', '_static/doctools.js', '_static/theme.js', '_static/searchtools.js',
                '_static/jquery.mousewheel.js', '_static/jquery.jscrollpane.min.js'],
...
htmlhelp_basename = 'biicodedocsdoc'
...
latex_documents = [
  ('index', 'biicodedocs.tex', u'biicode docs Documentation',
   u'biicode', 'manual'),
]
...
man_pages = [
    ('index', 'biicodedocs', u'biicode docs Documentation',
     [u'biicode'], 1)
]
...
texinfo_documents = [
  ('index', 'biicodedocs', u'biicode docs Documentation',
   u'biicode', 'biicodedocs', 'One line description of project.',
   'Miscellaneous'),
]
...
epub_title = u'biicode docs'
epub_author = u'biicode'
epub_publisher = u'biicode'
epub_copyright = u'2014, biicode'
